      ...
      <v-flex xs8>
        ...
        <v-card class='ma-2' >
          <v-card-title >
            ...
            <v-spacer></v-spacer>
            <v-btn small color='primary' ><v-icon >play_arrow</v-icon> Run</v-btn>
          </v-card-title>
          <v-divider></v-divider>
          <v-card-text>
        ...
        <v-card v-if='activeProcess'
          ...
          <v-card-title >
            <h1 class='subheading ma-2' >
              {{task.registered_task.service}}.{{task.registered_task.name}}
            </h1>
          </v-card-title>
          <v-divider></v-divider>
          <v-card-text>
            ...
            <section class='mx-3' >
              ...
              <div>
                ...
                <span v-else >
                  Run: {{task.schedule_offset_from_now}} after creation
                </span>
              </div>
              ...
              <div v-if='task.is_async' >
                Runs syncronously.
                Response will be returned with initial query</div>
              <div><strong>Runner:</strong> {{task.runner}}</div>
            </section>
